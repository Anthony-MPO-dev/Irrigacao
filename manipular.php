<?php 
  ...
  include('conexao.php');
    ...
    {
        //buscar a imagem do usuario no banco de dados
    ...
    <body>
        ...
        <div class="container text-center mt-5">
            ...
            <div class="my-5 text-center">
                ...
                <form action="cadastroSis.php" method="POST" >  
                    <div class="d-block mx-auto">   

                        <div class="form-row d-block mt-5 mb-3">

                            <div class="form-group mx-auto mt-5 my-2 col-md-6 col-sm-8">

                                <label for="idArd">Digite o número do equipamento (número de série)</label>
                                <input type="int" class="form-control" name="idArd" placeholder="Exemplo: 112233">
                        ...
                        <div class="g-recaptcha" data-sitekey="6Ldcn7sUAAAAAJgn1Y0hJg3iaCWYKPTcRFVZaImm">
...
<div>
    ...
    <form action="manipularSis.php" method="POST">  
                    
        <div>
            <label>Digite o número do equipamento (número de série)</label>
            <input type="int" name="idArd" placeholder="Exemplo: 112233">
        </div>

        <div>
            <select name="estado_modulo" id="estado">
                <option value="" ></option>
        ...
        <br>
        <div class="g-recaptcha" data-sitekey="6Ldcn7sUAAAAAJgn1Y0hJg3iaCWYKPTcRFVZaImm"></div>
