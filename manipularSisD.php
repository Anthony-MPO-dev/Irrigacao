<?php
	...
	if ($S_SESSION['id_modulo'] = null) {
    	...
    	if($resultado){
				...
				echo"<script language='javascript' type='text/javascript'>alert('Modulo desligado com sucesso!');window.location.href='user.php';</script>";

				$_SESSION['estado_modulo'] = 0;
