   ...
   <br><br>
    ...
    <div id="content">
        ...
        <div id="pagnone" class="container-fluid p-0">
            <form method="POST" action="alterar_user.php" name="f1" enctype="multipart/form-data">
        	<div class="row col">
        		
        		<div class="col-lg-5 col-sm-12">
        		 	<i class="py-0 text-center"> <?php echo '<img id="foto-perfil" name="img" class="mx-auto rounded d-block" src="data:image/jpeg;base64,'.base64_encode($_SESSION["img_usuario"]).'"/>'; ?></i>

                    <br>

                    <a id="button1" class="btn btn-success d-block mx-auto"><i class="fa fa-search " aria-hidden="true"></i> Procurar Imagem</a>
        		 		...
        		 		<table class="h5 table table-borderless my-5">
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><input type="text" name="inputNome" onkeypress="espaco();" id="inputNome" required class="form-control" placeholder="Primeiro Nome"></td>
						    </tr>
                            <tr>
                              <th scope="row">Sobrenome:</th>
                              <td><input type="text" name="inputSobrenome" id="inputSobrenome" required class="form-control" placeholder="Sobrenome"></td>
                            </tr>
						    <tr>
						      <th scope="row">Email:</th>
						      <td><input type="text" name="inputEmail" id="inputEmail" required placeholder="email@email.com"  class="form-control"></td>
						    </tr>
						    <tr>
						      <th scope="row">Tell:</th>
						      <td> <input type="text" required name="inputTell" id="InputTell" placeholder="XX XXXXX-XXXX"  onkeypress="formatarTell('XX XXXXX-XXXX',this);" maxlength="13" class="form-control"></td>
						    </tr>
        		...
        		<div class="col-lg-7 col-sm-12 my-0">
        			<table class="h5 table table-borderless my-0">
						  <tbody>
						    ...
						    <tr>
						      <th scope="row">CEP:</th>
						      <td> <input type="search" name="cep" id="cep" required placeholder="00000-000"  onkeypress="formatarCEP('#####-###', this);" minlength="9" maxlength="9" class="form-control"></td>
						    </tr>
						    <tr>
						      <th scope="row">Rua:</th>
						      <td><input type="text" id="inputRua" name="inputRua" required  class="form-control inputCadastro" placeholder=""></td>
						    </tr>
						    <tr>
						      <th scope="row">Bairro:</th>
						      <td> <input type="text" name="inputBairro" id="inputBairro" required class="form-control inputCadastro" placeholder=""></td>
						    </tr>
						     <tr>
						      <th scope="row">Nº d'Casa:</th>
						      <td> <input type="text" name="inputNumCasa" id="inputNumCasa" required class="form-control" placeholder="nº-000"></td>
						    </tr>
						     <tr>
						      <th scope="row">Cidade:</th>
						      <td> <input type="text" name="inputCidade" id="inputCidade" required placeholder="" class="form-control inputCadastro"></td>
						    </tr>
						     <tr>
						      <th scope="row">UF:</th>
						      <td><select id="inputEstado" name="inputEstado" required class="form-control inputCadastro">
						...
						<input class="mx-auto btn btn-success p-1 my-5"  type="submit" id="big-botao" value="Enviar Dados">
